      ...
      <div className='container'>
        ...
        <div className='video-container'>
            <div className='video-lgbox resp-img-box'>
                <a href='#'><Image src='/img/video_big.png' layout="fill" className='resp-img' alt=''/></a>
            </div>
            <div className='video-thumbbox'>
                <div className='thumb-wrap'>
                    <div className='thumb-row'>
                        <a href='#'>
                            <i className='thumb-img resp-img-box'><Image src='/img/video_thumb.png' layout="fill" className='resp-img' alt=''/></i>
                    ...
                    <div className='thumb-row'>
                        <a href='#'>
                            <i className='thumb-img  resp-img-box'><Image src='/img/video_thumb01.png'   layout="fill" className='resp-img' alt=''/></i>
                            <div className='video-info'>
